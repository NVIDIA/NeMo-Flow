...
| Current v5 extension | Context-carrying tool execution intercept registration. The callback receives one JSON object containing `tool_name`, `arguments`, and `tool_call_id`. |
