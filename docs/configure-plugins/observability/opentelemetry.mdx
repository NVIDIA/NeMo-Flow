...
HTTPS endpoints. Configure the final collector URL directly. This changes behavior
for existing endpoints that rely on redirects and prevents redirected exports from
bypassing transport validation or forwarding payloads and credentials to another
destination. This policy applies to all trace projections; gRPC, log, and metric
