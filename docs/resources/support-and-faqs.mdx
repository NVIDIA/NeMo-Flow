...
AI coding assistants receive the repository guidance automatically. They should
use `README.md` and the documentation index for user-facing runtime concepts,
supported bindings, and documented workflows.
