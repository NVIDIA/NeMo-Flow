...
Command replies and pushed events share the socket, while HTTP streams use
separate connections. An idle control-event listener does not delay commands or
