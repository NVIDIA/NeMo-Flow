...
async fn perform_request(
    ...
    let stream_id = format!("{request_ordinal:016x}");
...
fn make_scenario(
    ...
    ScenarioRecord {
        ...
        unavailable_metrics: vec![
            "reconnect count requires connection lifecycle instrumentation",
            "per-connection active HTTP/2 streams require connection-level instrumentation",
